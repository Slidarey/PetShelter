...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String nameTv = cursor.getString(nameColumnIndex);
        String breedTv = cursor.getString(breedColumnIndex);

        nameTextView.setText(nameTv);
        if (TextUtils.isEmpty(breedTv)) {
            breedTextView.setText(R.string.unknown_breed);
        } else {
            breedTextView.setText(breedTv);
        }
