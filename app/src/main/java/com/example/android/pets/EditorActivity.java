...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mPetUri == null) {
            ...
            //Otherwise this is an existing pet, so the change the app bar to say "Edit Pet"
    ...
    private void savePet() {
        ...
        //we can't simply use this line of code because of some cases when the user inputs nothing
        //this method below will try to convert the weightString argument to an integer and if the
        //weightString is empty, a NumberFormatException will be thrown
        ...
        if (mPetUri == null) {
            ...
            if (newRowId == -1) {
                Toast.makeText(this, getString(R.string.add_pet_unsuccessful), Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, getString(R.string.add_pet_successful), Toast.LENGTH_SHORT).show();
            }
        } else {
            ...
            // we want to modify.
            int numbersOfRowUpdated = getContentResolver().update(mPetUri, values, null, null);
            if (numbersOfRowUpdated == 1) {
                Toast.makeText(this, R.string.edit_pet_successful, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, R.string.edit_pet_unsuccessful, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data.moveToFirst()) {
            ...
            String breedValue = data.getString(breedColumnIndex);
            int genderValue = data.getInt(genderColumnIndex);
            int weightValue = data.getInt(weightColumnIndex);

            // Update the views on the screen with the values from the database
            mNameEditText.setText(nameValue);
            mBreedEditText.setText(breedValue);
            mWeightEditText.setText(Integer.toString(weightValue));
